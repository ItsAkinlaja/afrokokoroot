          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex flex-col gap-y-4 sm:flex-row sm:justify-center sm:gap-x-6 items-center">
              <Input
                ...
                className="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 placeholder:text-gray-400 h-12 w-full sm:w-80"
              />
              <Button 
                variant="default" 
                size="lg" 
                className="flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 h-12 w-full sm:w-auto"
              >
                Subscribe
              </Button>
            </div>
