  ...
  return (
    <section className="py-24 bg-orange-50 relative overflow-hidden rounded-b-[3rem] shadow-xl">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-orange-100/50 via-transparent to-transparent opacity-70" />
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-200/30 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-1/2 left-0 w-64 h-64 bg-orange-200/30 rounded-full blur-3xl animate-pulse delay-700" />
      </div>
      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="space-y-4">
            <h2 className="text-4xl font-bold tracking-tight text-foreground">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-orange-600">Our Programs</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl">
              From classrooms to stages, we bring transformative arts experiences to life through rhythm and movement.
            </p>
          </div>
          <Button asChild variant="ghost" className="hidden md:inline-flex group text-primary hover:text-primary/80 hover:bg-orange-100/50">
            <Link href="/programs">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {programs.slice(0, 3).map((program: Program) => {
            ...
            return (
              <div key={program.title} className="group relative overflow-hidden rounded-3xl bg-white border border-orange-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col p-8">
                ...
                <div className="mb-6 inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-orange-50 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 group-hover:scale-110 shadow-sm">
